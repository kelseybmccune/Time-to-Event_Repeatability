...
```
In these data, we also find identical ICC estimates between the coxme models using the classic and exploded data sets. Similar to the frog data, we see that the binomial GLMM results in a smaller ICC value.

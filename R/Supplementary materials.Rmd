---
title: "Supplementary materials for the manuscript: Repeatability and intra-class correlations from time-to-event data"
output: html_document
author: 'Kelsey B. McCune^1^, Martin Stoffel^2^, Coralie Williams^3^, Ned A. Dochtermann^4^, Holger Schielzeth^5^ and Shinichi Nakagawa^3,6^'
date: "2024-05-08"
---
...
3) Evolution & Ecology Centre and School of Biological, Earth and Environmental Sciences, University of New South Wales, Sydney, New South Wales, Australia
...
coxme_pval(c1,fdata,boot=100) # as there were no fixed effects in our model, the likelihood ratio test returns an NA value. 
...
coxme_pval(ctw.cox,ctw,boot=100) 
...
coxme_pval(dist.cox,dist,boot=100) # bootstrapping: ID p-value < 0.01; SPP p-value < 0.01 
